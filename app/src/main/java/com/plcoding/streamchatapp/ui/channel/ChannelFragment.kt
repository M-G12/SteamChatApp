...
import com.gharibe.smartapps.streamchatapp.databinding.FragmentChannelBinding
...
class ChannelFragment : BindingFragment<FragmentChannelBinding>() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.channelListView.setChannelItemClickListener{
            findNavController().navigateSafely(R.id.action_channelFragment3_to_chatFragment,
            Bundle().apply {
                putString(
                    "channelId",
                    it.cid
        ...
        binding.channelListHeaderView.setOnActionButtonClickListener {
            ...
            findNavController().navigateSafely(
                R.id.action_channelFragment3_to_createChannelDialog
            )
        }
